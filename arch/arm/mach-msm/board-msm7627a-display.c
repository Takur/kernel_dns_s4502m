...
#ifdef CONFIG_FB_MSM_MIPI_TRULY_IPS540960_4_E_VIDEO_MODE
#define LCD_MODULE_NAME "mipi_video_truly_ips540960_4_e_qhd"
#elif defined CONFIG_FB_MSM_MIPI_TRULY_IPS540960_4_E_CMD_MODE
#define LCD_MODULE_NAME "mipi_cmd_truly_ips540960_4_e_qhd"
#endif
...
static int msm_fb_detect_panel(const char *name)
{
	...
	if (machine_is_msm7x27a_surf() || machine_is_msm7625a_surf() ||
		...
		if (!strncmp(name, "lcdc_truly_hvga_ips3p2335_pt", 28))
            ...
            #if defined CONFIG_FB_MSM_MIPI_TRULY_IPS540960_4_E_VIDEO_MODE \
                || defined CONFIG_FB_MSM_MIPI_TRULY_IPS540960_4_E_CMD_MODE
...
#if defined CONFIG_FB_MSM_MIPI_TRULY_IPS540960_4_E_VIDEO_MODE \
           || defined CONFIG_FB_MSM_MIPI_TRULY_IPS540960_4_E_CMD_MODE
static int mipi_truly_ips540960_4_e_rotate_panel(void)
{
   return 0;
}
#else
...
static struct msm_panel_common_pdata mipi_truly_ips540960_4_e_pdata = {
   ...
   .rotate_panel = mipi_truly_ips540960_4_e_rotate_panel,
};
#else
...
#if defined CONFIG_FB_MSM_MIPI_TRULY_IPS540960_4_E_VIDEO_MODE \
           || defined CONFIG_FB_MSM_MIPI_TRULY_IPS540960_4_E_CMD_MODE
static struct platform_device mipi_dsi_truly_ips540960_4_e_panel_device = {
   .name = "mipi_truly_ips540960_4_e",
   .id   = 0,
   .dev  = {
       .platform_data = &mipi_truly_ips540960_4_e_pdata,
   }
};
#else
...
#if defined CONFIG_FB_MSM_MIPI_TRULY_IPS540960_4_E_VIDEO_MODE \
               || defined CONFIG_FB_MSM_MIPI_TRULY_IPS540960_4_E_CMD_MODE
   &mipi_dsi_truly_ips540960_4_e_panel_device,
#else
...
void msm7x27a_set_display_params(char *prim_panel)
{
	...
	if (strnlen(msm_fb_pdata.prim_panel_name, PANEL_NAME_MAX_LEN)) {
       ...
       if (strncmp((char *)msm_fb_pdata.prim_panel_name,
           "mipi_cmd_truly_ips540960_4_e_qhd",
           strnlen("mipi_cmd_truly_ips540960_4_e_qhd",
               PANEL_NAME_MAX_LEN)) &&
           strncmp((char *)msm_fb_pdata.prim_panel_name,
           "mipi_video_truly_ips540960_4_e_qhd",
           strnlen("mipi_video_truly_ips540960_4_e_qhd",
               PANEL_NAME_MAX_LEN)))
#else
...
#if defined CONFIG_FB_MSM_MIPI_TRULY_IPS540960_4_E_VIDEO_MODE \
                || defined CONFIG_FB_MSM_MIPI_TRULY_IPS540960_4_E_CMD_MODE
       mipi_truly_ips540960_4_e_pdata.bl_lock = 1;
#else
