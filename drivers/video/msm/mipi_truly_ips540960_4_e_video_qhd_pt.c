...
static int mipi_video_truly_ips540960_4_e_qhd_pt_init(void)
{
	int ret;

	if (msm_fb_detect_client("mipi_video_truly_ips540960_4_e_qhd"))
		return 0;
	...
	ret = mipi_truly_ips540960_4_e_device_register(&pinfo, MIPI_DSI_PRIM,
...
module_init(mipi_video_truly_ips540960_4_e_qhd_pt_init);
