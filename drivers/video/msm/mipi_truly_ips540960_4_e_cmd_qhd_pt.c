...
static int mipi_cmd_truly_ips540960_4_e_qhd_pt_init(void)
{
	int ret;

	pr_debug("%s: E\n", __func__);

	if (msm_fb_detect_client("mipi_cmd_truly_ips540960_4_e_qhd"))
		return 0;
...
module_init(mipi_cmd_truly_ips540960_4_e_qhd_pt_init);
